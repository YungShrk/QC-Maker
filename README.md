...
Then hit the run button in the top right (triange) and enter the inputs it asks at the bottom, name of show (havent got to features yet), number of seasons, and number of episodes.
